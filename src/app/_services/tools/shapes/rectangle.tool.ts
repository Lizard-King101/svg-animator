...
export class Rectangle extends Tool {
    ...
    private clearActiveRectangle() {
        if(this.editor.activeElement instanceof Shape && this.editor.activeElement.type == 'rectangle') {
    ...
    override drag(event: MouseEvent) {
        if(this.startPoint && this.editor.activeElement instanceof Shape && this.editor.activeElement.type == 'rectangle') {
            const point = this.editor.toCanvasPoint(event.clientX, event.clientY);
    ...
    override up() {
        if(this.editor.selectedSVG && this.editor.activeElement instanceof Shape && this.editor.activeElement.type == 'rectangle') {
