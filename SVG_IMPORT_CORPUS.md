...
Counts are a diagnostic snapshot, while tests use conservative minimums where future native coverage may legitimately convert more preserved nodes into editable elements. Each reduction in the preserved column should correspond to native model, editing, persistence, and export coverage—not merely successful rendering.
